...
+'<tr></tr>'
+'<tr><td style="background-color:Orange;height:10px;width:30px;opacity:.8;border:1px solid Orange;"></td><td>La localité est accessible par une route en terre battue.<br>Les habitations sont desservies par des rue en terre battue<br>et des piste plus étroites</td></tr>'
+'<tr></tr>'
+'<tr><td style="background-color:Red;height:10px;width:30px;opacity:.8;border:1px solid Red;"></td><td>La localité n\'est accessible par une piste étroite<br>ne permettant que le passage de deux roues.</td></tr>'
+'</table>'
+'</details>'
+'</div>'
;
